    ...
    class Book {
        public:
            ...
            Book(string t, float p, int s){
                ...
                cout << "Book of Name: " << title << ", Price: " << price << ", Stock: " << *stock << " Has been Created!" << endl;
            }
            ...
            Book(Book &obj){
                ...
                cout << "Book of Name: " << title << ", Price: " << price << ", Stock: " << *stock << " Has been Copied!" << endl;
            }
            
            ~Book(){
                cout << "Book of Name: " << title << ", Price: " << price << ", Stock: " << *stock << " Has been Destroyed!" << endl;
                delete stock;
            }
            ...
            void applyDiscount(int buy){
                if (buy > 5 && buy < 11){
                    ...
                    cout << "Original cost: " << (price * buy) << endl;
                    cout << " New Discounted cost: " << (price * 0.95 * buy) << endl;
                }
                else if (buy > 11){
                    cout << "DISCOUNT APPLIED!" << endl;
                    cout << "Original cost: " << (price * buy) << endl;
                    cout << " New Discounted cost: " << (price * 0.90 * buy) << endl;
                }
                else{
                    cout << "No changes to the price" << endl;
                    cout << "Cost: " << (price * buy) << endl;
                }
            }
